# -*- coding: utf-8 -*-
"""
This is a web spider experiment based on selenium.webdriver.
...
code page. The good thing is we can get the image urls by using
`webdriver.Chrome().get(url_base)`.
Free to use.
